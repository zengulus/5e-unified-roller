(function (root, factory) {
    ...
    const ID_REFS = Object.freeze({
        ...
        annotationLayerEl: 'vtt-annotation-layer',
        ...
        playerDrawButtonEl: 'vtt-player-draw-btn',
        playerUndoAnnotationButtonEl: 'vtt-player-undo-annotation-btn',
        ...
        toolModeDrawEl: 'vtt-tool-mode-draw',
        ...
        headerBoardMenuEl: 'vtt-header-board-menu',
        caseBoardModalEl: 'vtt-case-board-modal',
        caseBoardFrameEl: 'vtt-case-board-frame',
        caseBoardCaseLabelEl: 'vtt-case-board-case-label',
        caseBoardPopoutEl: 'vtt-case-board-popout',
        caseBoardHeaderPopoutEl: 'vtt-case-board-header-popout',
