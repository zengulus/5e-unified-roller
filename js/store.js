(function (global) {
    ...
    const sanitizeVTTProximityTrigger = (trigger, idx = 0) => {
        ...
        return {
            ...
            clockId: toTrimmedString(source.clockId, '', 120).trim(),
            clockSuccessDelta: Math.max(-20, Math.min(20, Math.round(toNumber(source.clockSuccessDelta, 0)))),
            clockFailDelta: Math.max(-20, Math.min(20, Math.round(toNumber(source.clockFailDelta, 0)))),
