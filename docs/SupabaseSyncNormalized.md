...
- `rtf_campaign_core`: one row per campaign (rep, heat, cognitive risk, case template/meta, ledger payload).
...
- `campaign.heat`, `campaign.cognitiveRisk`, `campaign.rep`, `campaign.case`, `campaign.ledger` -> `rtf_campaign_core`
