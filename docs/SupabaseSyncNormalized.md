...
> [!CAUTION]
> **TRUSTED GROUP ONLY.** The legacy baseline policies give every authenticated user access to every campaign row. They are not campaign membership or tenant isolation.
